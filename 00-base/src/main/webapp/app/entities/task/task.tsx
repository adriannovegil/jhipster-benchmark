...
export class Task extends React.Component<ITaskProps> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="task-heading">
          <Translate contentKey="benchmarkApp.task.home.title">Tasks</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="benchmarkApp.task.home.createLabel">Create a new Task</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {taskList && taskList.length > 0 ? (
            <Table responsive aria-describedby="task-heading">
              <thead>
                <tr>
                  ...
                  <th>
                    <Translate contentKey="benchmarkApp.task.title">Title</Translate>
                  </th>
                  <th>
                    <Translate contentKey="benchmarkApp.task.description">Description</Translate>
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="benchmarkApp.task.home.notFound">No Tasks found</Translate>
            </div>
          )}
        </div>
      </div>
