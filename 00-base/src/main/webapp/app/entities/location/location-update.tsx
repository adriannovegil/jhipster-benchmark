    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="benchmarkApp.location.home.createOrEditLabel">
              <Translate contentKey="benchmarkApp.location.home.createOrEditLabel">Create or edit a Location</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
