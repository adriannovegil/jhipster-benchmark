...
describe('Location e2e test', () => {
  ...
  it('should load create Location page', async () => {
    ...
    expect(await locationUpdatePage.getPageTitle().getAttribute('id')).to.match(/benchmarkApp.location.home.createOrEditLabel/);
  ...
  it('should delete last Location', async () => {
    ...
    expect(await locationDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/benchmarkApp.location.delete.question/);
