...
describe('Department e2e test', () => {
  ...
  it('should load create Department page', async () => {
    ...
    expect(await departmentUpdatePage.getPageTitle().getAttribute('id')).to.match(/benchmarkApp.department.home.createOrEditLabel/);
  ...
  it('should delete last Department', async () => {
    ...
    expect(await departmentDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/benchmarkApp.department.delete.question/);
