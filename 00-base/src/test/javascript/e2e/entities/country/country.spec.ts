...
describe('Country e2e test', () => {
  ...
  it('should load create Country page', async () => {
    ...
    expect(await countryUpdatePage.getPageTitle().getAttribute('id')).to.match(/benchmarkApp.country.home.createOrEditLabel/);
  ...
  it('should delete last Country', async () => {
    ...
    expect(await countryDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/benchmarkApp.country.delete.question/);
