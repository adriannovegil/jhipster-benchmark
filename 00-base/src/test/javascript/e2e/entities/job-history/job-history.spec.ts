...
describe('JobHistory e2e test', () => {
  ...
  it('should load create JobHistory page', async () => {
    ...
    expect(await jobHistoryUpdatePage.getPageTitle().getAttribute('id')).to.match(/benchmarkApp.jobHistory.home.createOrEditLabel/);
  ...
  it('should delete last JobHistory', async () => {
    ...
    expect(await jobHistoryDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/benchmarkApp.jobHistory.delete.question/);
