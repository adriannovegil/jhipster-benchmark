...
describe('Task e2e test', () => {
  ...
  it('should load create Task page', async () => {
    ...
    expect(await taskUpdatePage.getPageTitle().getAttribute('id')).to.match(/benchmarkApp.task.home.createOrEditLabel/);
  ...
  it('should delete last Task', async () => {
    ...
    expect(await taskDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/benchmarkApp.task.delete.question/);
