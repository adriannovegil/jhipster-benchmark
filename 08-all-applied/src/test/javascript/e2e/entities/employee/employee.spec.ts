...
describe('Employee e2e test', () => {
  ...
  it('should load create Employee page', async () => {
    ...
    expect(await employeeUpdatePage.getPageTitle().getAttribute('id')).to.match(/benchmarkApp.employee.home.createOrEditLabel/);
  ...
  it('should delete last Employee', async () => {
    ...
    expect(await employeeDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/benchmarkApp.employee.delete.question/);
