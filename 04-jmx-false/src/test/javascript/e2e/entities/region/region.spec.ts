...
describe('Region e2e test', () => {
  ...
  it('should load create Region page', async () => {
    ...
    expect(await regionUpdatePage.getPageTitle().getAttribute('id')).to.match(/benchmarkApp.region.home.createOrEditLabel/);
  ...
  it('should delete last Region', async () => {
    ...
    expect(await regionDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/benchmarkApp.region.delete.question/);
