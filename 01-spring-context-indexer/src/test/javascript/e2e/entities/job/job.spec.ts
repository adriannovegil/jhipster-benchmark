...
describe('Job e2e test', () => {
  ...
  it('should load create Job page', async () => {
    ...
    expect(await jobUpdatePage.getPageTitle().getAttribute('id')).to.match(/benchmarkApp.job.home.createOrEditLabel/);
  ...
  it('should delete last Job', async () => {
    ...
    expect(await jobDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/benchmarkApp.job.delete.question/);
